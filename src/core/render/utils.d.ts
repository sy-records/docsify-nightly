 ...
 */
export function getAndRemoveConfig(str?: string): {
    str: string;
 ...
 */
export function removeAtag(str?: string): string;
/**
 ...
 */
export function getAndRemoveDocsifyIgnoreConfig(content?: string): {
    content: string;
