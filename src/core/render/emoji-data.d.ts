declare namespace _default {
    ...
    let data: {
        ...
        face_holding_back_tears: string;
        face_in_clouds: string;
        face_with_diagonal_mouth: string;
        face_with_head_bandage: string;
        face_with_open_eyes_and_hand_over_mouth: string;
        face_with_peeking_eye: string;
