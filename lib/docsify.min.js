...
/**
  	 ...
  	 * @namespace
  	 * @public
  	 */e.exports&&(e.exports=n),void 0!==W&&(W.Prism=n),n.languages.markup={comment:{pattern:/<!--(?:(?!<!--)[\s\S])*?-->/,greedy:!0},prolog:{pattern:/<\?[\s\S]+?\?>/,greedy:!0},doctype:{pattern:/<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,greedy:!0,inside:{"internal-subset":{pattern:/(^[^\[]*\[)[\s\S]+(?=\]>$)/,lookbehind:!0,greedy:!0,inside:null},string:{pattern:/"[^"]*"|'[^']*'/,greedy:!0},punctuation:/^<!|>$|[[\]]/,"doctype-tag":/^DOCTYPE/i,name:/[^\s<>'"]+/}},cdata:{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,greedy:!0},tag:{pattern:/<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/>])))+)?\s*\/?>/,greedy:!0,inside:{tag:{pattern:/^<\/?[^\s>\/]+/,inside:{punctuation:/^<\/?/,namespace:/^[^\s>\/:]+:/}},"special-attr":[],"attr-value":{pattern:/=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+)/,inside:{punctuation:[{pattern:/^=/,alias:"attr-equals"},{pattern:/^(\s*)["']|["']$/,lookbehind:!0}]}},punctuation:/\/?>/,"attr-name":{pattern:/[^\s>\/]+/,inside:{namespace:/^[^\s>\/:]+:/}}}},entity:[{pattern:/&[\da-z]{1,8};/i,alias:"named-entity"},/&#x?[\da-f]{1,8};/i]},n.languages.markup.tag.inside["attr-value"].inside.entity=n.languages.markup.entity,n.languages.markup.doctype.inside["internal-subset"].inside=n.languages.markup,n.hooks.add("wrap",(function(e){"entity"===e.type&&(e.attributes.title=e.content.replace(/&amp;/,"&"))})),Object.defineProperty(n.languages.markup.tag,"addInlined",{value:function(e,i){var t={};t["language-"+i]={pattern:/(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,lookbehind:!0,inside:n.languages[i]},t.cdata=/^<!\[CDATA\[|\]\]>$/i;var o={"included-cdata":{pattern:/<!\[CDATA\[[\s\S]*?\]\]>/i,inside:t}};o["language-"+i]={pattern:/[\s\S]+/,inside:n.languages[i]};var a={};a[e]={pattern:RegExp(/(<__[^>]*>)(?:<!\[CDATA\[(?:[^\]]|\](?!\]>))*\]\]>|(?!<!\[CDATA\[)[\s\S])*?(?=<\/__>)/.source.replace(/__/g,(function(){return e})),"i"),lookbehind:!0,greedy:!0,inside:o},n.languages.insertBefore("markup","cdata",a)}}),Object.defineProperty(n.languages.markup.tag,"addAttribute",{value:function(e,i){n.languages.markup.tag.inside["special-attr"].push({pattern:RegExp(/(^|["'\s])/.source+"(?:"+e+")"+/\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))/.source,"i"),lookbehind:!0,inside:{"attr-name":/^[^\s=]+/,"attr-value":{pattern:/=[\s\S]+/,inside:{value:{pattern:/(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/,lookbehind:!0,alias:[i,"language-"+i],inside:n.languages[i]},punctuation:[{pattern:/^=/,alias:"attr-equals"},/"|'/]}}}})}}),n.languages.html=n.languages.markup,n.languages.mathml=n.languages.markup,n.languages.svg=n.languages.markup,n.languages.xml=n.languages.extend("markup",{}),n.languages.ssml=n.languages.xml,n.languages.atom=n.languages.xml,n.languages.rss=n.languages.xml,function(e){var n=/(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;e.languages.css={comment:/\/\*[\s\S]*?\*\//,atrule:{pattern:RegExp("@[\\w-](?:"+/[^;{\s"']|\s+(?!\s)/.source+"|"+n.source+")*?"+/(?:;|(?=\s*\{))/.source),inside:{rule:/^@[\w-]+/,"selector-function-argument":{pattern:/(\bselector\s*\(\s*(?![\s)]))(?:[^()\s]|\s+(?![\s)])|\((?:[^()]|\([^()]*\))*\))+(?=\s*\))/,lookbehind:!0,alias:"selector"},keyword:{pattern:/(^|[^\w-])(?:and|not|only|or)(?![\w-])/,lookbehind:!0}}},url:{pattern:RegExp("\\burl\\((?:"+n.source+"|"+/(?:[^\\\r\n()"']|\\[\s\S])*/.source+")\\)","i"),greedy:!0,inside:{function:/^url/i,punctuation:/^\(|\)$/,string:{pattern:RegExp("^"+n.source+"$"),alias:"url"}}},selector:{pattern:RegExp("(^|[{}\\s])[^{}\\s](?:[^{};\"'\\s]|\\s+(?![\\s{])|"+n.source+")*(?=\\s*\\{)"),lookbehind:!0},string:{pattern:n,greedy:!0},property:{pattern:/(^|[^-\w\xA0-\uFFFF])(?!\s)[-_a-z\xA0-\uFFFF](?:(?!\s)[-\w\xA0-\uFFFF])*(?=\s*:)/i,lookbehind:!0},important:/!important\b/i,function:{pattern:/(^|[^-a-z0-9])[-a-z0-9]+(?=\()/i,lookbehind:!0},punctuation:/[(){};:,]/},e.languages.css.atrule.inside.rest=e.languages.css;var i=e.languages.markup;i&&(i.tag.addInlined("style","css"),i.tag.addAttribute("style","css"))}(n),n.languages.clike={comment:[{pattern:/(^|[^\\])\/\*[\s\S]*?(?:\*\/|$)/,lookbehind:!0,greedy:!0},{pattern:/(^|[^\\:])\/\/.*/,lookbehind:!0,greedy:!0}],string:{pattern:/(["'])(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/,greedy:!0},"class-name":{pattern:/(\b(?:class|extends|implements|instanceof|interface|new|trait)\s+|\bcatch\s+\()[\w.\\]+/i,lookbehind:!0,inside:{punctuation:/[.\\]/}},keyword:/\b(?:break|catch|continue|do|else|finally|for|function|if|in|instanceof|new|null|return|throw|try|while)\b/,boolean:/\b(?:false|true)\b/,function:/\b\w+(?=\()/,number:/\b0x[\da-f]+\b|(?:\b\d+(?:\.\d*)?|\B\.\d+)(?:e[+-]?\d+)?/i,operator:/[<>]=?|[!=]=?=?|--?|\+\+?|&&?|\|\|?|[?*/~^%]/,punctuation:/[{}[\];(),.:]/},n.languages.javascript=n.languages.extend("clike",{"class-name":[n.languages.clike["class-name"],{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$A-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\.(?:constructor|prototype))/,lookbehind:!0}],keyword:[{pattern:/((?:^|\})\s*)catch\b/,lookbehind:!0},{pattern:/(^|[^.]|\.\.\.\s*)\b(?:as|assert(?=\s*\{)|async(?=\s*(?:function\b|\(|[$\w\xA0-\uFFFF]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally(?=\s*(?:\{|$))|for|from(?=\s*(?:['"]|$))|function|(?:get|set)(?=\s*(?:[#\[$\w\xA0-\uFFFF]|$))|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/,lookbehind:!0}],function:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/,number:{pattern:RegExp(/(^|[^\w$])/.source+"(?:"+/NaN|Infinity/.source+"|"+/0[bB][01]+(?:_[01]+)*n?/.source+"|"+/0[oO][0-7]+(?:_[0-7]+)*n?/.source+"|"+/0[xX][\dA-Fa-f]+(?:_[\dA-Fa-f]+)*n?/.source+"|"+/\d+(?:_\d+)*n/.source+"|"+/(?:\d+(?:_\d+)*(?:\.(?:\d+(?:_\d+)*)?)?|\.\d+(?:_\d+)*)(?:[Ee][+-]?\d+(?:_\d+)*)?/.source+")"+/(?![\w$])/.source),lookbehind:!0},operator:/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/}),n.languages.javascript["class-name"][0].pattern=/(\b(?:class|extends|implements|instanceof|interface|new)\s+)[\w.\\]+/,n.languages.insertBefore("javascript","keyword",{regex:{pattern:RegExp(/((?:^|[^$\w\xA0-\uFFFF."'\])\s]|\b(?:return|yield))\s*)/.source+/\//.source+"(?:"+/(?:\[(?:[^\]\\\r\n]|\\.)*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}/.source+"|"+/(?:\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.|\[(?:[^[\]\\\r\n]|\\.)*\])*\])*\]|\\.|[^/\\\[\r\n])+\/[dgimyus]{0,7}v[dgimyus]{0,7}/.source+")"+/(?=(?:\s|\/\*(?:[^*]|\*(?!\/))*\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/.source),lookbehind:!0,greedy:!0,inside:{"regex-source":{pattern:/^(\/)[\s\S]+(?=\/[a-z]*$)/,lookbehind:!0,alias:"language-regex",inside:n.languages.regex},"regex-delimiter":/^\/|\/$/,"regex-flags":/^[a-z]+$/}},"function-variable":{pattern:/#?(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*[=:]\s*(?:async\s*)?(?:\bfunction\b|(?:\((?:[^()]|\([^()]*\))*\)|(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)\s*=>))/,alias:"function"},parameter:[{pattern:/(function(?:\s+(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*)?\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\))/,lookbehind:!0,inside:n.languages.javascript},{pattern:/(^|[^$\w\xA0-\uFFFF])(?!\s)[_$a-z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*=>)/i,lookbehind:!0,inside:n.languages.javascript},{pattern:/(\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*=>)/,lookbehind:!0,inside:n.languages.javascript},{pattern:/((?:\b|\s|^)(?!(?:as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?![$\w\xA0-\uFFFF]))(?:(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*\s*)\(\s*|\]\s*\(\s*)(?!\s)(?:[^()\s]|\s+(?![\s)])|\([^()]*\))+(?=\s*\)\s*\{)/,lookbehind:!0,inside:n.languages.javascript}],constant:/\b[A-Z](?:[A-Z_]|\dx?)*\b/}),n.languages.insertBefore("javascript","string",{hashbang:{pattern:/^#!.*/,greedy:!0,alias:"comment"},"template-string":{pattern:/`(?:\\[\s\S]|\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}|(?!\$\{)[^\\`])*`/,greedy:!0,inside:{"template-punctuation":{pattern:/^`|`$/,alias:"string"},interpolation:{pattern:/((?:^|[^\\])(?:\\{2})*)\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/,lookbehind:!0,inside:{"interpolation-punctuation":{pattern:/^\$\{|\}$/,alias:"punctuation"},rest:n.languages.javascript}},string:/[\s\S]+/}},"string-property":{pattern:/((?:^|[,{])[ \t]*)(["'])(?:\\(?:\r\n|[\s\S])|(?!\2)[^\\\r\n])*\2(?=\s*:)/m,lookbehind:!0,greedy:!0,alias:"property"}}),n.languages.insertBefore("javascript","operator",{"literal-property":{pattern:/((?:^|[,{])[ \t]*)(?!\s)[_$a-zA-Z\xA0-\uFFFF](?:(?!\s)[$\w\xA0-\uFFFF])*(?=\s*:)/m,lookbehind:!0,alias:"property"}}),n.languages.markup&&(n.languages.markup.tag.addInlined("script","javascript"),n.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source,"javascript")),n.languages.js=n.languages.javascript,function(){if(void 0!==n&&"undefined"!=typeof document){Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector);var e={js:"javascript",py:"python",rb:"ruby",ps1:"powershell",psm1:"powershell",sh:"bash",bat:"batch",h:"c",tex:"latex"},i="data-src-status",t="loading",o="loaded",a="pre[data-src]:not(["+i+'="'+o+'"]):not(['+i+'="'+t+'"])';n.hooks.add("before-highlightall",(function(e){e.selector+=", "+a})),n.hooks.add("before-sanity-check",(function(c){var r=c.element;if(r.matches(a)){c.code="",r.setAttribute(i,t);var s=r.appendChild(document.createElement("CODE"));s.textContent="Loading…";var u=r.getAttribute("data-src"),f=c.language;if("none"===f){var d=(/\.(\w+)$/.exec(u)||[,"none"])[1];f=e[d]||d}n.util.setLanguage(s,f),n.util.setLanguage(r,f);var g=n.plugins.autoloader;g&&g.loadLanguages(f),function(e,n,i){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4==t.readyState&&(t.status<400&&t.responseText?n(t.responseText):t.status>=400?i("✖ Error "+t.status+" while fetching file: "+t.statusText):i("✖ Error: File does not exist or is empty"))},t.send(null)}(u,(function(e){r.setAttribute(i,o);var t=function(e){var n=/^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(e||"");if(n){var i=Number(n[1]),t=n[2],o=n[3];return t?o?[i,Number(o)]:[i,void 0]:[i,i]}}(r.getAttribute("data-range"));if(t){var a=e.split(/\r\n?|\n/g),c=t[0],u=null==t[1]?a.length:t[1];c<0&&(c+=a.length),c=Math.max(0,Math.min(c-1,a.length)),u<0&&(u+=a.length),u=Math.max(0,Math.min(u,a.length)),e=a.slice(c,u).join("\n"),r.hasAttribute("data-start")||r.setAttribute("data-start",String(c+1))}s.textContent=e,n.highlightElement(s)}),(function(e){r.setAttribute(i,"failed"),s.textContent=e}))}})),n.plugins.fileHighlight={highlight:function(e){for(var i,t=(e||document).querySelectorAll(a),o=0;i=t[o++];)n.highlightElement(i)}};var c=!1;n.fileHighlight=function(){c||(console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),c=!0),n.plugins.fileHighlight.highlight.apply(this,arguments)}}}()}(cn);var rn=X(cn.exports);!function(e){function n(e,n){return"___"+e.toUpperCase()+n+"___"}Object.defineProperties(e.languages["markup-templating"]={},{buildPlaceholders:{value:function(i,t,o,a){if(i.language===t){var c=i.tokenStack=[];i.code=i.code.replace(o,(function(e){if("function"==typeof a&&!a(e))return e;for(var o,r=c.length;-1!==i.code.indexOf(o=n(t,r));)++r;return c[r]=e,o})),i.grammar=e.languages.markup}}},tokenizePlaceholders:{value:function(i,t){if(i.language===t&&i.tokenStack){i.grammar=e.languages[t];var o=0,a=Object.keys(i.tokenStack);!function c(r){for(var s=0;s<r.length&&!(o>=a.length);s++){var u=r[s];if("string"==typeof u||u.content&&"string"==typeof u.content){var f=a[o],d=i.tokenStack[f],g="string"==typeof u?u:u.content,p=n(t,f),l=g.indexOf(p);if(l>-1){++o;var v=g.substring(0,l),h=new e.Token(t,e.tokenize(d,i.grammar),"language-"+t,d),_=g.substring(l+p.length),m=[];v&&m.push.apply(m,c([v])),m.push(h),_&&m.push.apply(m,c([_])),"string"==typeof u?r.splice.apply(r,[s,1].concat(m)):u.content=m}}else u.content&&c(u.content)}return r}(i.tokens)}}}})}(Prism);const sn={},un={markdown:e=>({url:e}),mermaid:e=>({url:e}),iframe:(e,n)=>({html:`<iframe src="${e}" ${n||"width=100% height=400"}></iframe>`}),video:(e,n)=>({html:`<video src="${e}" ${n||"controls"}>Not Support</video>`}),audio:(e,n)=>({html:`<audio src="${e}" ${n||"controls"}>Not Support</audio>`}),code(e,n){let i=e.match(/\.(\w+)$/);return i=n||i&&i[1],"md"===i&&(i="markdown"),{url:e,lang:i}}};class fn{constructor(n,t){this.config=n,this.router=t,this.cacheTree={},this.toc=[],this.cacheTOC={},this.linkTarget=n.externalLinkTarget||"_blank",this.linkRel="_blank"===this.linkTarget?n.externalLinkRel||"noopener":"",this.contentBase=t.getBasePath();const a=this._initRenderer();let c;this.heading=a.heading;const r=n.markdown||{};o(r)?c=r(Ye,a):(Ye.setOptions(Object.assign(r,{renderer:Object.assign(a,r.renderer)})),c=Ye),this._marked=c,this.compile=t=>{let o=!0;const a=e((e=>{o=!1;let a="";return t?(a=i(t)?c(t):c.parser(t),a=n.noEmoji?a:on(a,n.nativeEmoji),nn.clear(),a):t}))(t),r=this.router.parse().file;return o?this.toc=this.cacheTOC[r]:this.cacheTOC[r]=[...this.toc],a}}compileEmbed(e,n){const{str:i,config:t}=an(n);let o;if(n=i,t.include){let i;if(z(e)||(e=C(this.contentBase,E(this.router.getCurrentPath()),e)),t.type&&(i=un[t.type]))o=i.call(this,e,n),o.type=t.type;else{let i="code";/\.(md|markdown)/.test(e)?i="markdown":/\.mmd/.test(e)?i="mermaid":/\.html?/.test(e)?i="iframe":/\.(mp4|ogg)/.test(e)?i="video":/\.mp3/.test(e)&&(i="audio"),o=un[i].call(this,e,n),o.type=i}return o.fragment=t.fragment,o}}_matchNotCompileLink(e){const n=this.config.noCompileLinks||[];for(const i of n){if((sn[i]||(sn[i]=new RegExp(`^${i}$`))).test(e))return e}}_initRenderer(){const e=new Ye.Renderer,{linkTarget:n,linkRel:i,router:t,contentBase:o}=this,a=this,c={};return c.heading=e.heading=function(e,n){let{str:i,config:o}=an(e);const c={level:n,title:i},{content:r,ignoreAllSubs:s,ignoreSubHeading:u}=function(e=""){let n,i;return/<!-- {docsify-ignore} -->/g.test(e)&&(e=e.replace("\x3c!-- {docsify-ignore} --\x3e",""),i=!0),/{docsify-ignore}/g.test(e)&&(e=e.replace("{docsify-ignore}",""),i=!0),/<!-- {docsify-ignore-all} -->/g.test(e)&&(e=e.replace("\x3c!-- {docsify-ignore-all} --\x3e",""),n=!0),/{docsify-ignore-all}/g.test(e)&&(e=e.replace("{docsify-ignore-all}",""),n=!0),{content:e,ignoreAllSubs:n,ignoreSubHeading:i}}(i);i=r.trim(),c.title=function(e=""){return e.replace(/(<\/?a.*?>)/gi,"")}(i),c.ignoreAllSubs=s,c.ignoreSubHeading=u;const f=nn(o.id||i),d=t.toURL(t.getCurrentPath(),{id:f});return c.slug=d,a.toc.push(c),`<h${n} id="${f}"><a href="${d}" data-id="${f}" class="anchor"><span>${i}</span></a></h${n}>`},c.code=(({renderer:e})=>e.code=function(e,n="markup"){const i=rn.languages[n]||rn.languages.markup;return`<pre v-pre data-lang="${n}"><code class="lang-${n}">${rn.highlight(e.replace(/@DOCSIFY_QM@/g,"`"),i,n)}</code></pre>`})({renderer:e}),c.link=(({renderer:e,router:n,linkTarget:i,linkRel:t,compilerClass:o})=>e.link=(e,a="",c)=>{let r=[];const{str:s,config:u}=an(a);return i=u.target||i,t="_blank"===i?o.config.externalLinkRel||"noopener":"",a=s,z(e)||o._matchNotCompileLink(e)||u.ignore?(z(e)||"./"!==e.slice(0,2)||(e=document.URL.replace(/\/(?!.*\/).*/,"/").replace("#/./","")+e),r.push(0===e.indexOf("mailto:")?"":`target="${i}"`),r.push(0===e.indexOf("mailto:")?"":""!==t?` rel="${t}"`:"")):(e===o.config.homepage&&(e="README"),e=n.toURL(e,null,n.getCurrentPath())),u.disabled&&(r.push("disabled"),e="javascript:void(0)"),u.class&&r.push(`class="${u.class}"`),u.id&&r.push(`id="${u.id}"`),a&&r.push(`title="${a}"`),`<a href="${e}" ${r.join(" ")}>${c}</a>`})({renderer:e,router:t,linkTarget:n,linkRel:i,compilerClass:a}),c.paragraph=(({renderer:e})=>e.paragraph=e=>{let n;return n=/^!&gt;/.test(e)?We("tip",e):/^\?&gt;/.test(e)?We("warn",e):`<p>${e}</p>`,n})({renderer:e}),c.image=(({renderer:e,contentBase:n,router:i})=>e.image=(e,t,o)=>{let a=e,c=[];const{str:r,config:s}=an(t);if(t=r,s["no-zoom"]&&c.push("data-no-zoom"),t&&c.push(`title="${t}"`),s.size){const[e,n]=s.size.split("x");n?c.push(`width="${e}" height="${n}"`):c.push(`width="${e}"`)}return s.class&&c.push(`class="${s.class}"`),s.id&&c.push(`id="${s.id}"`),z(e)||(a=C(n,E(i.getCurrentPath()),e)),`<img src="${a}" data-origin="${e}" alt="${o}" ${c.join(" ")} />`})({renderer:e,contentBase:o,router:t}),c.list=(({renderer:e})=>e.list=(e,n,i)=>{const t=n?"ol":"ul";return`<${t} ${[/<li class="task-list-item">/.test(e.split('class="task-list"')[0])?'class="task-list"':"",i&&i>1?`start="${i}"`:""].join(" ").trim()}>${e}</${t}>`})({renderer:e}),c.listitem=(({renderer:e})=>e.listitem=e=>/^(<input.*type="checkbox"[^>]*>)/.test(e)?`<li class="task-list-item"><label>${e}</label></li>`:`<li>${e}</li>`)({renderer:e}),e.origin=c,e}sidebar(e,n){const{toc:i}=this,t=this.router.getCurrentPath();let o="";if(e)o=this.compile(e);else{for(let e=0;e<i.length;e++)if(i[e].ignoreSubHeading){const n=i[e].level;i.splice(e,1);for(let t=e;t<i.length&&n<i[t].level;t++)i.splice(t,1)&&t--&&e++;e--}const e=this.cacheTree[t]||Xe(i,n);o=Ge(e,"<ul>{inner}</ul>"),this.cacheTree[t]=e}return o}subSidebar(e){if(!e)return void(this.toc=[]);const n=this.router.getCurrentPath(),{cacheTree:i,toc:t}=this;t[0]&&t[0].ignoreAllSubs&&t.splice(0),t[0]&&1===t[0].level&&t.shift();for(let e=0;e<t.length;e++)t[e].ignoreSubHeading&&t.splice(e,1)&&e--;const o=i[n]||Xe(t,e);return i[n]=o,this.toc=[],Ge(o)}header(e,n){return this.heading(e,n)}article(e){return this.compile(e)}cover(e){const n=this.toc.slice(),i=this.compile(e);return this.toc=n.slice(),i}}let dn,gn;function pn(e){const{loaded:n,total:i,step:t}=e;let o;!dn&&function(){const e=l("div");e.classList.add("progress"),v(f,e),dn=e}(),void 0!==t?(o=parseInt(dn.style.width||0,10)+t,o=o>80?80:o):o=Math.floor(n/i*100),dn.style.opacity=1,dn.style.width=o>=95?"100%":o+"%",o>=95&&(clearTimeout(gn),gn=setTimeout((e=>{dn.style.opacity=0,dn.style.width="0%"}),200))}const ln={};function vn(e,n=!1,i={}){const o=new XMLHttpRequest,a=ln[e];if(a)return{then:e=>e(a.content,a.opt),abort:t};o.open("GET",e);for(const e of Object.keys(i))o.setRequestHeader(e,i[e]);return o.send(),{then(i,a=t){if(n){const e=setInterval((e=>pn({step:Math.floor(5*Math.random()+1)})),500);o.addEventListener("progress",pn),o.addEventListener("loadend",(n=>{pn(n),clearInterval(e)}))}o.addEventListener("error",a),o.addEventListener("load",(n=>{const t=n.target;if(t.status>=400)a(n);else{if("string"!=typeof t.response)throw new TypeError("Unsupported content type.");const n=ln[e]={content:t.response,opt:{updatedAt:o.getResponseHeader("last-modified")??""}};i(n.content,n.opt)}}))},abort:e=>4!==o.readyState&&o.abort()}}const hn={};function _n({compiler:e,raw:n="",fetch:i},t){let o=hn[n];if(o){const e=o.slice();return e.links=o.links,t(e)}const a=e._marked;let c=a.lexer(n);const r=[],s=a.Lexer.rules.inline.link,u=c.links;c.forEach(((n,i)=>{"paragraph"===n.type&&(n.text=n.text.replace(new RegExp(s.source,"g"),((n,t,o,a)=>{const c=e.compileEmbed(o,a);return c&&r.push({index:i,embed:c}),n})))}));const f=[];!function({embedTokens:e,compile:n,fetch:i},t){let o,a=0,c=0;if(!e.length)return t({});for(;o=e[a++];){const i=o,a=o=>{let a;if(o)if("markdown"===i.embed.type){let e=i.embed.url.split("/");e.pop(),e=e.join("/"),o=o.replace(/\[([^[\]]+)\]\(([^)]+)\)/g,(n=>{const i=n.indexOf("(");return"(."===n.slice(i,i+2)?n.substring(0,i)+`(${window.location.protocol}//${window.location.host}${e}/`+n.substring(i+1,n.length-1)+")":n})),!0===(($docsify.frontMatter||{}).installed||!1)&&(o=$docsify.frontMatter.parseMarkdown(o)),a=n.lexer(o)}else if("code"===i.embed.type){if(i.embed.fragment){const e=i.embed.fragment,n=new RegExp(`(?:###|\\/\\/\\/)\\s*\\[${e}\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[${e}\\]`);o=K((o.match(n)||[])[1]||"").trim()}a=n.lexer("```"+i.embed.lang+"\n"+o.replace(/`/g,"@DOCSIFY_QM@")+"\n```\n")}else"mermaid"===i.embed.type?(a=[{type:"html",text:`<div class="mermaid">\n${o}\n</div>`}],a.links={}):(a=[{type:"html",text:o}],a.links={});t({token:i,embedToken:a}),++c>=e.length&&t({})};o.embed.url?vn(o.embed.url).then(a):a(o.embed.html)}}({compile:a,embedTokens:r,fetch:i},(({embedToken:e,token:i})=>{if(i){let n=i.index;f.forEach((e=>{n>e.start&&(n+=e.length)})),Object.assign(u,e.links),c=c.slice(0,n).concat(e,c.slice(n+1)),f.push({start:n,length:e.length-1})}else hn[n]=c.concat(),c.links=hn[n].links=u,t(c)}))}let mn;function bn(e,n,i){var t,o,a,c;return n="function"==typeof i?i(n):"string"==typeof i?(a=[],c=0,(t=i).replace(H,(function(e,n,i){a.push(t.substring(c,i-1)),c=i+=e.length+1,a.push(o&&o[e]||function(n){return("00"+("string"==typeof D[e]?n[D[e]]():D[e](n))).slice(-e.length)})})),c!==t.length&&a.push(t.substring(c)),function(e){for(var n="",i=0,t=e||new Date;i<a.length;i++)n+="string"==typeof a[i]?a[i]:a[i](t);return n})(new Date(n)):n,e.replace(/{docsify-updated}/g,n)}function kn(e){const n=this.config,i=g(".markdown-section"),t="Vue"in window&&window.Vue.version&&Number(window.Vue.version.charAt(0)),o=e=>{const n=Boolean(e.__vue__&&e.__vue__._isVue),i=Boolean(e._vnode&&e._vnode.__v_skip);return n||i};if(e||(e="<h1>404 - Not found</h1>"),"Vue"in window){const e=p(".markdown-section > *").filter((e=>o(e)));for(const n of e)2===t?n.__vue__.$destroy():3===t&&n.__vue_app__.unmount()}if(this._renderTo(i,e),!n.loadSidebar&&this._renderSidebar(),(n.executeScript||"Vue"in window&&!1!==n.executeScript)&&function(){const e=p(".markdown-section>script").filter((e=>!/template/.test(e.type)))[0];if(!e)return!1;const n=e.innerText.trim();if(!n)return!1;new Function(n)()}(),"Vue"in window){const e=[],a=Object.keys(n.vueComponents||{});if(2===t&&a.length&&a.forEach((e=>{!window.Vue.options.components[e]&&window.Vue.component(e,n.vueComponents[e])})),!mn&&n.vueGlobalOptions&&"function"==typeof n.vueGlobalOptions.data&&(mn=n.vueGlobalOptions.data()),e.push(...Object.keys(n.vueMounts||{}).map((e=>[g(i,e),n.vueMounts[e]])).filter((([e,n])=>e))),n.vueGlobalOptions||a.length){const i=/{{2}[^{}]*}{2}/,t=/<[^>/]+\s([@:]|v-)[\w-:.[\]]+[=>\s]/;e.push(...p(".markdown-section > *").filter((n=>!e.some((([e,i])=>e===n)))).filter((e=>e.tagName.toLowerCase()in(n.vueComponents||{})||e.querySelector(a.join(",")||null)||i.test(e.outerHTML)||t.test(e.outerHTML))).map((e=>{const i={...n.vueGlobalOptions};return mn&&(i.data=()=>mn),[e,i]})))}for(const[i,c]of e){const e="data-isvue";if(!(i.matches("pre, script")||o(i)||i.querySelector(`[${e}]`)))if(i.setAttribute(e,""),2===t)c.el=void 0,new window.Vue(c).$mount(i);else if(3===t){const e=window.Vue.createApp(c);a.forEach((i=>{const t=n.vueComponents[i];e.component(i,t)})),e.mount(i)}}}}function wn(e){return class extends e{_renderTo(e,n,i){const t=s(e);t&&(t[i?"outerHTML":"innerHTML"]=n)}_renderSidebar(e){const{maxLevel:n,subMaxLevel:i,loadSidebar:t,hideSidebar:o}=this.config;if(o)return[document.querySelector("aside.sidebar"),document.querySelector("button.sidebar-toggle")].filter((e=>!!e)).forEach((e=>e.parentNode.removeChild(e))),document.querySelector("section.content").style.right="unset",document.querySelector("section.content").style.left="unset",document.querySelector("section.content").style.position="relative",document.querySelector("section.content").style.width="100%",null;this._renderTo(".sidebar-nav",this.compiler.sidebar(e,n));const a=Z(this.router,".sidebar-nav",!0,!0);t&&a?a.parentNode.innerHTML+=this.compiler.subSidebar(i)||"":this.compiler.subSidebar(),this._bindEventOnRendered(a)}_bindEventOnRendered(e){const{autoHeader:n}=this.config;if(function(e){const n=g(".cover.show");ce=n?n.offsetHeight:0;const i=s(".sidebar");let t=[];null!=i&&(t=p(i,"li"));for(const n of t){const i=n.querySelector("a");if(!i)continue;let t=i.getAttribute("href");if("/"!==t){const{query:{id:n},path:i}=e.parse(t);n&&(t=se(i,n))}t&&(ie[decodeURIComponent(t)]=n)}if(c)return;const o=A(e.getCurrentPath());m("scroll",(()=>re(o))),_("scroll",(()=>re(o))),_(i,"mouseover",(()=>{te=!0})),_(i,"mouseleave",(()=>{te=!1}))}(this.router),n&&e){const n=s("#main"),i=n.children[0];if(i&&"H1"!==i.tagName){h(n,l("div",this.compiler.header(e.innerText,1)).children[0])}}}_renderNav(e){e&&this._renderTo("nav",this.compiler.compile(e)),this.config.loadNavbar&&Z(this.router,"nav")}_renderMain(e,n={},i){if(!e)return kn.call(this,e);this.callHook("beforeEach",e,(t=>{let o;const a=()=>{n.updatedAt&&(o=bn(o,n.updatedAt,this.config.formatUpdated)),this.callHook("afterEach",o,(e=>{kn.call(this,e),i()}))};this.isHTML?(o=this.result=e,a()):_n({compiler:this.compiler,raw:t},(e=>{o=this.compiler.compile(e),a()}))}))}_renderCover(e,n){const i=s(".cover");if(b(s("main"),n?"add":"remove","hidden"),!e)return void b(i,"remove","show");b(i,"add","show");let t=this.coverIsHTML?e:this.compiler.cover(e);const o=t.trim().match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$');if(o){if("color"===o[2])i.style.background=o[1]+(o[3]||"");else{let e=o[1];b(i,"add","has-mask"),z(o[1])||(e=C(this.router.getBasePath(),o[1])),i.style.backgroundImage=`url(${e})`,i.style.backgroundSize="cover",i.style.backgroundPosition="center center"}t=t.replace(o[0],"")}this._renderTo(".cover-main",t),U()}_updateRender(){!function(e){const n=s(".app-name-link"),t=e.config.nameLink,o=e.route.path;if(n)if(i(e.config.nameLink))n.setAttribute("href",t);else if("object"==typeof t){const e=Object.keys(t).filter((e=>o.indexOf(e)>-1))[0];n.setAttribute("href",t[e])}}(this)}initRender(){const e=this.config;this.compiler=new fn(e,this.router),window.__current_docsify_compiler__=this.compiler;const n=e.el||"#app",i=g("nav")||l("nav"),t=g(n);let o="",a=f;if(t){if(e.repo&&(o+=(r=e.repo,s=e.cornerExternalLinkTarget,r?(/\/\//.test(r)||(r="https://github.com/"+r),`\n    <a href="${r=r.replace(/^git\+/,"")}" target="${s=s||"_blank"}" class="github-corner" aria-label="View source on Github">\n      <svg viewBox="0 0 250 250" aria-hidden="true">\n        <path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path>\n        <path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path>\n        <path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path>\n      </svg>\n    </a>\n  `):"")),e.coverpage&&(o+=function(){const e=", 100%, 85%";return`\n    <section class="cover show" style="background: \n    linear-gradient(\n      to left bottom,\n      hsl(${Math.floor(255*Math.random())+e}) 0%,\n      hsl(${Math.floor(255*Math.random())+e}) 100%\n    )\n  ">\n      <div class="mask"></div>\n      <div class="cover-main">\x3c!--cover--\x3e</div>\n    </section>\n  `}()),e.logo){const n=/^data:image/.test(e.logo),i=/(?:http[s]?:)?\/\//.test(e.logo),t=/^\./.test(e.logo);n||i||t||(e.logo=C(this.router.getBasePath(),e.logo))}o+=function(e){const n=e.name?e.name:"";return`\n    <main>\n    <button class="sidebar-toggle" aria-label="Menu">\n      <div class="sidebar-toggle-button">\n        <span></span><span></span><span></span>\n      </div>\n    </button>\n    <aside class="sidebar">\n      ${e.name?`\n            <h1 class="app-name"><a class="app-name-link" data-nosearch>${e.logo?`<img alt="${n}" src=${e.logo} />`:n}</a></h1>\n          `:""}\n      <div class="sidebar-nav">\x3c!--sidebar--\x3e</div>\n    </aside>\n  \n      <section class="content">\n        <article class="markdown-section" id="main">\x3c!--main--\x3e</article>\n      </section>\n    </main>\n  `}(e),this._renderTo(t,o,!0)}else this.rendered=!0;var r,s,d;e.mergeNavbar&&c?a=g(".sidebar"):(i.classList.add("app-nav"),e.repo||i.classList.add("no-badge")),e.loadNavbar&&h(a,i),e.themeColor&&u.head.appendChild(l("div",(d=e.themeColor,`<style>:root{--theme-color: ${d};}</style>`)).firstElementChild),this._updateRender(),b(f,"ready")}}}function yn(e,n,i,t,o,a){e=a?e:e.replace(/\/$/,""),(e=E(e))&&vn(o.router.getFile(e+i)+n,!1,o.config.requestHeaders).then(t,(a=>yn(e,n,i,t,o)))}function xn(e){let n;const i=(e,i)=>(n&&n.abort&&n.abort(),n=vn(e,!0,i),n);return class extends e{_loadSideAndNav(e,n,i,t){return()=>{if(!i)return t();yn(e,n,i,(e=>{this._renderSidebar(e),t()}),this,!0)}}_fetch(e=t){const{query:n}=this.route;let{path:o}=this.route;if(a(o))history.replaceState(null,"","#"),this.router.normalize();else{const t=S(n,["id"]),{loadNavbar:c,requestHeaders:r,loadSidebar:s}=this.config,u=this.router.getFile(o);this.isRemoteUrl=a(u),this.isHTML=/\.html$/g.test(u);const f=(n,i)=>{this._renderMain(n,i,this._loadSideAndNav(o,t,s,e))},d=n=>{this._fetchFallbackPage(o,t,e)||this._fetch404(u,t,e)};this.isRemoteUrl?i(u+t,r).then(f,d):this.matchVirtualRoute(o).then((e=>{"string"==typeof e?f(e):i(u+t,r).then(f,d)})),c&&yn(o,t,c,(e=>this._renderNav(e)),this,!0)}}_fetchCover(){const{coverpage:e,requestHeaders:n}=this.config,i=this.route.query,t=E(this.route.path);if(e){let o=null;const a=this.route.path;if("string"==typeof e)"/"===a&&(o=e);else if(Array.isArray(e))o=e.indexOf(a)>-1&&"_coverpage";else{const n=e[a];o=!0===n?"_coverpage":n}const c=Boolean(o)&&this.config.onlyCover;return o?(o=this.router.getFile(t+o),this.coverIsHTML=/\.html$/g.test(o),vn(o+S(i,["id"]),!1,n).then((e=>this._renderCover(e,c)))):this._renderCover(null,c),c}}$fetch(e=t,n=this.$resetEvents.bind(this)){const i=()=>{this.callHook("doneEach"),e()};this._fetchCover()?i():this._fetch((()=>{n(),i()}))}_fetchFallbackPage(e,n,o=t){const{requestHeaders:a,fallbackLanguages:c,loadSidebar:r}=this.config;if(!c)return!1;const s=e.split("/")[1];if(-1===c.indexOf(s))return!1;const u=this.router.getFile(e.replace(new RegExp(`^/${s}`),""));return i(u+n,a).then(((i,t)=>this._renderMain(i,t,this._loadSideAndNav(e,n,r,o))),(i=>this._fetch404(e,n,o))),!0}_fetch404(e,n,o=t){const{loadSidebar:a,requestHeaders:c,notFoundPage:r}=this.config,s=this._loadSideAndNav(e,n,a,o);if(r){const n=((e,n)=>{const{notFoundPage:i,ext:t}=n,o="_404"+(t||".md");let a,c;switch(typeof i){case"boolean":c=o;break;case"string":c=i;break;case"object":a=Object.keys(i).sort(((e,n)=>n.length-e.length)).filter((n=>e.match(new RegExp("^"+n))))[0],c=a&&i[a]||o}return c})(e,this.config);return i(this.router.getFile(n),c).then(((e,n)=>this._renderMain(e,n,s)),(e=>this._renderMain(null,{},s))),!0}return this._renderMain(null,{},s),!1}initFetch(){const{loadSidebar:e}=this.config;if(this.rendered){const n=Z(this.router,".sidebar-nav",!0,!0);e&&n&&(n.parentNode.innerHTML+=window.__SUB_SIDEBAR__),this._bindEventOnRendered(n),this.$resetEvents(),this.callHook("doneEach"),this.callHook("ready")}else this.$fetch((e=>this.callHook("ready")))}}}function $n(e){return class extends e{$resetEvents(e){const{auto2top:n}=this.config;"history"!==e&&(this.route.query.id&&ue(this.route.path,this.route.query.id),"navigate"===e&&n&&function(e=0){fe.scrollTop=!0===e?0:Number(e)}(n)),this.config.loadNavbar&&Z(this.router,"nav")}initEvent(){var e;!function(e){const n=e=>f.classList.toggle("close");null!=(e=s(e))&&(_(e,"click",(e=>{e.stopPropagation(),n()})),c&&_(f,"click",(e=>f.classList.contains("close")&&n())))}("button.sidebar-toggle",this.router),e=".sidebar",this.router,null!=(e=s(e))&&_(e,"click",(({target:e})=>{"A"===e.nodeName&&e.nextSibling&&e.nextSibling.classList&&e.nextSibling.classList.contains("app-sub-sidebar")&&b(e.parentNode,"collapse")})),this.config.coverpage?!c&&_("scroll",U):f.classList.add("sticky")}}}function Sn(e){return class extends e{routes(){return this.config.routes||{}}matchVirtualRoute(e){const n=this.routes(),i=Object.keys(n);let t=()=>null;function o(){const a=i.shift();if(!a)return t(null);const c=function(e){const n=e.startsWith("^")?e:`^${e}`;return n.endsWith("$")?n:`${n}$`}(a),r=e.match(c);if(!r)return o();const s=n[a];if("string"==typeof s){return t(s)}if("function"==typeof s){const n=s,[i,a]=function(){let e=()=>null;return[function(n){e(n)},function(n){e=n}]}();if(a((e=>"string"==typeof e?t(e):!1===e?t(null):o())),n.length<=2){return i(n(e,r))}return n(e,r,i)}return o()}return{then(e){t=e,o()}}}}}var zn=Object.freeze({__proto__:null,cached:e,cleanPath:F,getParentPath:E,getPath:C,hyphenate:n,inBrowser:!0,isAbsolutePath:z,isExternal:a,isFn:o,isMobile:c,isPrimitive:i,noop:t,parseQuery:$,removeParams:A,replaceSlug:L,resolvePath:T,stringifyQuery:S});class An extends(xn($n(wn(Sn(function(e){return class extends e{constructor(...e){super(...e),this.route={}}updateRender(){this.router.normalize(),this.route=this.router.parse(),f.setAttribute("data-page",this.route.file)}initRouter(){const e=this.config;let n;n="history"===(e.routerMode||"hash")?new I(e):new M(e),this.router=n,this.updateRender(),N=this.route,n.onchange((e=>{this.updateRender(),this._updateRender(),N.path!==this.route.path?(this.$fetch(t,this.$resetEvents.bind(this,e.source)),N=this.route):this.$resetEvents(e.source)}))}}}(function(e){return class extends e{initLifecycle(){this._hooks={},this._lifecycle={},["init","mounted","beforeEach","afterEach","doneEach","ready"].forEach((e=>{const n=this._hooks[e]=[];this._lifecycle[e]=e=>n.push(e)}))}callHook(e,n,i=t){const o=this._hooks[e],a=this.config.catchPluginErrors,c=function(e){const t=o[e];if(e>=o.length)i(n);else if("function"==typeof t){const i="Docsify plugin error";if(2===t.length)try{t(n,(i=>{n=i,c(e+1)}))}catch(n){if(!a)throw n;console.error(i,n),c(e+1)}else try{const i=t(n);n=void 0===i?n:i,c(e+1)}catch(n){if(!a)throw n;console.error(i,n),c(e+1)}}else c(e+1)};c(0)}}}(Object))))))){constructor(){super(),this.config=ne(this),this.initLifecycle(),this.initPlugin(),this.callHook("init"),this.initRouter(),this.initRender(),this.initEvent(),this.initFetch(),this.callHook("mounted")}initPlugin(){this.config.plugins.forEach((e=>{try{o(e)&&e(this._lifecycle,this)}catch(e){if(!this.config.catchPluginErrors)throw e;{const n="Docsify plugin error";console.error(n,e)}}}))}}window.Docsify={util:zn,dom:w,get:vn,slugify:nn,version:"4.13.0"},window.DocsifyCompiler=fn,window.marked=Ye,window.Prism=rn,k((e=>new An))}();
